 ...
 * @author sirji
 */
public class Window_1 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        //Logo Image
        Image logo = new Image(Window_1.class.getResourceAsStream("air-logo.png")); 
        ...
        scene.getStylesheets().add(Window_1.class.getResource("Windows.css").toExternalForm());
